...
`;function Ol(e){return new qi({name:`Pura two-interface liquid`,uniforms:{uBackground:{value:e},uViewProjection:{value:new un},uWorldToDrop:{value:new un},uDropToWorld:{value:new un},uTint:{value:new Z(`#5dd7e7`)},uDaylight:{value:0},uIor:{value:1.333},uSurfaceBend:{value:new q}},depthWrite:!0,toneMapped:!0,vertexShader:`
    ...
    `})}var kl=Math.PI*2*3.1,Al=3.4,jl=Math.sqrt(kl*kl-Al*Al),Ml=1/12,Nl=.26,Pl=.25,Fl=(e,t,n)=>Math.max(t,Math.min(n,e)),Il=class{constructor(){a(this,`stretch`,0),a(this,`stretchVelocity`,0),a(this,`squash`,0),a(this,`angle`,0),a(this,`previousVx`,0),a(this,`previousVy`,0),a(this,`previousGrabbed`,!1)}get snapshot(){return{stretch:this.stretch,squash:this.squash,angle:this.angle}}reset(){this.stretch=this.stretchVelocity=this.squash=this.angle=0,this.previousVx=this.previousVy=0,this.previousGrabbed=!1}update(e,t,n=!1){if(n)return this.reset(),this.observe(e),this.snapshot;if(!Number.isFinite(t)||t<=0)return this.snapshot;let r=Math.min(t,Ml),i=Math.hypot(e.vx,e.vy),a=Math.hypot(this.previousVx,this.previousVy),o=Math.hypot(e.wallImpulse.x,e.wallImpulse.y),s=i-a,c=Math.hypot(e.vx-this.previousVx,e.vy-this.previousVy),l=Math.max(0,c-Math.abs(s)),u=Math.min(.026,i/32e3)+(o>0?0:Fl(s*.006+l*.003,-5,5))/(kl*kl*r);this.previousGrabbed&&!e.grabbed&&(i>20||Math.abs(this.stretch)>.006)&&(this.stretchVelocity-=Math.min(2.7,.9+i/650+Math.abs(this.stretch)*3)),o>0&&(this.stretchVelocity-=Math.min(5,o*.0045),this.squash=Math.min(Pl,this.squash+o/7e3)),this.stretchVelocity=Fl(this.stretchVelocity,-7,7);let d=this.stretch-u,f=Math.exp(-3.4*r),p=Math.cos(jl*r),m=Math.sin(jl*r),h=this.stretchVelocity;this.stretch=u+f*(d*p+(h+Al*d)/jl*m),this.stretchVelocity=f*(h*p-(Al*h+kl*kl*d)/jl*m);let g=Fl(this.stretch,-.26,Nl);if(g!==this.stretch&&(this.stretch=g,this.stretch*this.stretchVelocity>0&&(this.stretchVelocity=0)),this.squash*=Math.exp(-r*9),i>10||o>0){let t=o>0?Math.atan2(-e.wallImpulse.y,e.wallImpulse.x):Math.atan2(-e.vy,e.vx),n=Math.atan2(Math.sin((t-this.angle)*2),Math.cos((t-this.angle)*2))/2;this.angle+=n*(1-Math.exp(-r*15))}return this.observe(e),this.snapshot}observe(e){this.previousVx=e.vx,this.previousVy=e.vy,this.previousGrabbed=e.grabbed}},Ll=1/12,Rl=.24,zl=.03,Bl=.4,Vl=.045,Hl=.065,Ul=class{constructor(){a(this,`x`,0),a(this,`y`,0)}get snapshot(){return{x:this.x,y:this.y,strength:Math.hypot(this.x,this.y)}}reset(){this.x=this.y=0}update(e,t,n=!1){if(n)return this.reset(),this.snapshot;if(!Number.isFinite(t)||t<=0)return this.snapshot;let r=Math.min(t,Ll),i=0,a=0;if(e.grabbed&&e.pointer&&Number.isFinite(e.r)&&e.r>0){let t=(e.pointer.x-e.x)/e.r,n=-(e.pointer.y-e.y)/e.r,r=Math.hypot(t,n);if(Number.isFinite(r)&&r>zl){let e=Math.min(Rl,(r-zl)*Bl);i=t/r*e,a=n/r*e}}let o=i===0&&a===0,s=-Math.expm1(-r/(o?Hl:Vl));return this.x+=(i-this.x)*s,this.y+=(a-this.y)*s,this.snapshot}},Wl=.065,Gl=.028,Kl=1/12,ql=.03,Jl=.105,Yl=.018,Xl=.085,Zl=.08,Ql=.065,$l=.01,eu=(e,t,n)=>Math.max(t,Math.min(n,e)),tu=(e,t,n)=>Number.isFinite(e)?eu(e,t,n):0;function nu(e,t,n){let r=tu(e,-.26,.26),i=tu(t,0,.25),a=Math.sqrt(1+tu(n,0,Gl)),o=(1+r)*a,s=(1-r*.46+i)*a;return{x:o,y:s,z:1/(o*s)}}var ru=class{constructor(){a(this,`bendX`,0),a(this,`bendY`,0),a(this,`edgeX`,0),a(this,`edgeY`,0),a(this,`press`,0),a(this,`previousGrabbed`,!1)}get snapshot(){let e=this.bendX+this.edgeX,t=this.bendY+this.edgeY,n=Math.hypot(e,t),r=n>.065?Wl/n:1;return{bendX:e*r,bendY:t*r,press:this.press}}reset(){this.bendX=this.bendY=this.edgeX=this.edgeY=this.press=0,this.previousGrabbed=!1}update(e,t,n=!1){if(n)return this.reset(),this.previousGrabbed=e.grabbed,this.snapshot;if(!Number.isFinite(t)||t<=0)return this.snapshot;let r=Math.min(t,Kl);if(e.grabbed&&!this.previousGrabbed){this.press=Gl;let t=e.grabPoint,n=t&&Number.isFinite(t.x)?t.x:0,r=t&&Number.isFinite(t.y)?t.y:0,i=$l/Math.max(1,Math.hypot(n,r));this.edgeX=n*i,this.edgeY=r*i}let i=0,a=0;if(e.grabbed&&e.pointer&&Number.isFinite(e.r)&&e.r>0){let t=(e.pointer.x-e.x)/e.r,n=-(e.pointer.y-e.y)/e.r,r=Math.hypot(t,n);if(Number.isFinite(r)&&r>ql){let e=Math.min(Wl,(r-ql)*Jl);i=t/r*e,a=n/r*e}}let o=i===0&&a===0,s=-Math.expm1(-r/(o?Xl:Yl));return this.bendX+=(i-this.bendX)*s,this.bendY+=(a-this.bendY)*s,this.edgeX*=Math.exp(-r/Ql),this.edgeY*=Math.exp(-r/Ql),this.press*=Math.exp(-r/Zl),this.previousGrabbed=e.grabbed,this.snapshot}},iu={cyan:`#5dd7e7`,rose:`#eb729e`,amber:`#f5bc54`},au=.01,ou=.47,su={roughness:.035,ior:1.333,absorptionDistance:2.6,thickness:1.05,exposure:1.05,maxStretch:.26,maxSquash:.25,taperRatio:.16};function cu(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);if(e){n.fillStyle=`#909598`,n.fillRect(0,0,1024,1024);for(let e=0;e<16;e++)for(let t=0;t<16;t++)(t+e)%2&&(n.fillStyle=`#575e63`,n.fillRect(t*64,e*64,64,64)),n.fillStyle=`#d8ddd9`,n.fillRect(t*64+30,e*64+25,1,12),n.fillRect(t*64+25,e*64+30,12,1)}else{let e=n.createImageData(1024,1024),t=127;for(let n=0;n<1024;n++)for(let r=0;r<1024;r++){t=Math.imul(t,1664525)+1013904223|0;let i=(t>>>0)/4294967296,a=Math.sin(r*.012+Math.sin(n*.009)*3)*3,o=i>.997?12:0,s=127+(i-.5)*9+a+o,c=(n*1024+r)*4;e.data[c]=s,e.data[c+1]=s+2,e.data[c+2]=s+4,e.data[c+3]=255}n.putImageData(e,0,0)}let r=new Ai(t);return r.colorSpace=Xe,r.wrapS=r.wrapT=v,r.repeat.set(3,3),r}function lu(e,t){let n=new Kn;n.add(new ui(new Pi(30,30,30),new Qr({color:t?`#83949a`:`#343d49`,side:1})));function r(e,t,r,i,a,o){let s=new ui(new Ii(e,t),new Qr({color:new Z(...o),side:2}));s.position.set(r,i,a),s.lookAt(0,0,0),n.add(s)}r(7.5,2.3,-3,3.6,5,t?[22,22,20]:[20,22,24]),r(.85,5.2,4.5,.5,3.5,[18,21,24]),r(4.5,.65,0,-4.5,.65,[13,15,18]),r(3.2,1.7,-3.2,-3.8,1.6,t?[3,2.8,2.3]:[1.4,1.5,1.6]),r(1.3,3,.8,5.5,.7,[.9,1.1,1.25]);let i=new Do(e),a=i.fromScene(n,.035,.1,60);return i.dispose(),n.traverse(e=>{e instanceof ui&&(e.geometry.dispose(),e.material.dispose())}),a}function uu(){return new qi({transparent:!0,depthWrite:!1,uniforms:{color:{value:new Z(iu.cyan)},gain:{value:1}},vertexShader:`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`
      ...
      }`})}function du(){return new qi({transparent:!0,depthWrite:!1,blending:2,uniforms:{color:{value:new Z(iu.cyan)},gain:{value:.34}},vertexShader:`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`
      varying vec2 vUv; uniform vec3 color; uniform float gain;
      void main(){
      ...
      }`})}function fu(e,t={},n){var r;let i=e.getContext(`webgl2`,{alpha:!1,antialias:!0,powerPreference:`high-performance`});if(!i)throw Error(`このブラウザでは水滴の描画を開始できません。WebGL 2対応のブラウザでお試しください。`);let a=new bl({canvas:e,context:i,antialias:!0});a.outputColorSpace=Xe,a.toneMapping=4,a.toneMappingExposure=su.exposure;let o=i.getExtension(`WEBGL_debug_renderer_info`);e.dataset.environment=JSON.stringify({userAgent:navigator.userAgent,webgl:i.getParameter(i.VERSION),renderer:o?i.getParameter(o.UNMASKED_RENDERER_WEBGL):i.getParameter(i.RENDERER),color:`linear render targets / ACES / sRGB output`});let s=new Kn;s.background=new Z(`#171e24`);let c=lu(a,!1);s.environment=c.texture;let l=new ja(34,1,.1,100);l.up.set(0,1,0);let u=new wl({radius:88}),d=new Il,f=new Ul,p=new ru,m={hue:`cyan`,lighting:`studio`,inspection:!1,reducedMotion:!1,paused:!1,quality:`high`,refinement:`refined`,clay:!1},h=[cu(!1),cu(!0)];for(let e of h)e.anisotropy=Math.min(8,a.capabilities.getMaxAnisotropy());let g=new Yi({color:`#455157`,map:h[0],roughness:.52,metalness:.12,envMapIntensity:.08,bumpMap:h[0],bumpScale:.004}),_=new ui(new Ii(40,40),g);_.position.z=-.012,s.add(_);let v=new ya(`#c9d8e2`,`#41454a`,1),y=new Pa(`#ebf3fa`,1.35);y.position.set(-4,4,8),s.add(v,y);let b=new Ri(1,96,64),x=b.getAttribute(`position`);for(let e=0;e<x.count;e++){let t=x.getZ(e);x.setZ(e,Math.max(.007,(t+.64)*.62))}b.computeVertexNormals(),b.boundingSphere=new Mr(new J(0,0,.5),1.16);let S=new Float32Array(x.array),C=b.getAttribute(`normal`),w=new Float32Array(C.array),T=new Xi({color:`#ffffff`,metalness:0,roughness:su.roughness,transmission:1,thickness:su.thickness,ior:su.ior,attenuationColor:iu.cyan,attenuationDistance:su.absorptionDistance,envMapIntensity:1.55,dispersion:.012}),E=new sn(1,1,{type:P});E.texture.colorSpace=``;let D=Ol(E.texture),O=new Yi({color:`#aab6b5`,roughness:.7,metalness:0,envMapIntensity:.45}),k=new URLSearchParams(location.search).get(`material`)===`physical`,A=new ui(b,k?T:D);A.frustumCulled=!1;let j=new Rn,M=new Rn;M.matrixAutoUpdate=!1,M.add(A),j.add(M),s.add(j);let N=new Rn;N.matrixAutoUpdate=!1,s.add(N);let ee=new ui(new Ii(4,4),uu());ee.position.z=-.003,N.add(ee);let te=new ui(new Ii(4,4),du());te.position.z=-.001,N.add(te);let ne=new Oi(new Br,new vi({color:`#9baeb7`,transparent:!0,opacity:.085}));ne.position.z=.001,s.add(ne);let re=new Qa,ie=new q,ae=new Wr(new J(0,0,1),0),F=new J,I=null,L=new q,R=new q,z=!1,oe=!1,se=0,ce=0,le=0,ue=[],de=0,fe=[],pe=!1,me=NaN,he=NaN,ge=NaN,_e=``,ve=0;function ye(){if(z||oe)return;let t=e.getBoundingClientRect();if(t.width<1||t.height<1)return;Se(),a.setPixelRatio(Math.min(devicePixelRatio||1,m.quality===`high`?2:1.25)),a.setSize(t.width,t.height,!1),a.transmissionResolutionScale=m.quality===`high`?1:.6;let n=m.quality===`high`?1:.7;E.setSize(Math.max(1,Math.round(e.width*n)),Math.max(1,Math.round(e.height*n)));let r=t.width/t.height,i=Bt.clamp(t.width*1.06,550,1200),o=i/r;u.resize(i,o),l.aspect=r;let s=u.snapshot.r*au,c=Math.max(22,Math.min(u.width,u.height)*.04)*au,d=(1+.64)*.62,f=su.maxStretch*su.taperRatio,p=Math.max(1+su.maxStretch,1+su.maxStretch*.46+su.maxSquash)*Math.sqrt(1+Gl),h=Math.max(f*Math.hypot(d*d,.4),Wl*(El-Tl)**2),g=1+Rl*.5,_=s*Rl*.5,v=s*p*g,y=Math.max(1+su.maxStretch*.34,nu(-su.maxStretch,0,0).z),b=Math.min(1-su.maxStretch*.34-su.maxSquash*.5,nu(su.maxStretch,su.maxSquash,Gl).z)/g,x=v*h,S=s*y*d*d*f*.3,C=u.width*au*.5-c-s,w=u.height*au*.5-c-s,T=Math.sin(ou),D=Math.cos(ou),O=Math.tan(Bt.degToRad(l.fov*.5)),k=.97,A=0,j=1/(O*r*k),M=1/(O*k);for(let[e,t,n]of[[j,-T,D],[-j,-T,D],[0,D*M-T,T*M+D],[0,-D*M-T,-T*M+D]]){let r=Math.hypot(e,t),i=n>=0?y:b,a=Math.hypot(r*v,n*s*.62*i)+n*s*.3968*i+r*(x+_)+Math.abs(n)*S;A=Math.max(A,Math.abs(e)*C+Math.abs(t)*w+a)}l.position.set(0,-Math.sin(ou)*A,Math.cos(ou)*A),l.lookAt(0,0,0),l.updateProjectionMatrix();let N=u.width*au*.5-c,P=u.height*au*.5-c;ne.geometry.dispose(),ne.geometry=new Br().setFromPoints([new J(-N,-P,0),new J(N,-P,0),new J(N,P,0),new J(-N,P,0)]),be()}function be(){ue=[],fe=[],de=0,pe=!1,delete e.dataset.benchmark}function xe(t){let n=e.getBoundingClientRect();return ie.set((t.clientX-n.left)/n.width*2-1,-(t.clientY-n.top)/n.height*2+1),re.setFromCamera(ie,l),re.ray.intersectPlane(ae,F)?{x:F.x/au+u.width*.5,y:u.height*.5-F.y/au}:null}function Se(){I!==null&&e.hasPointerCapture(I)&&e.releasePointerCapture(I),I=null,u.pointerUp(),e.style.cursor=`grab`}function Ce(r){var i;if(m.paused||oe||I!==null||r.pointerType===`mouse`&&r.button!==0)return;let a=xe(r);if(!a)return;j.updateMatrixWorld(!0);let o=re.intersectObject(A,!1)[0],s=u.snapshot;!o&&Math.hypot(a.x-s.x,a.y-s.y)>s.r+14||(L.set(a.x-s.x,a.y-s.y),o?R.set((o.point.x-j.position.x)/(s.r*au),(o.point.y-j.position.y)/(s.r*au)):R.set((a.x-s.x)/s.r,-(a.y-s.y)/s.r),R.clampLength(0,1),u.pointerDown(s.x,s.y)&&(n==null||n.grab(s.r,s.x,u.width),I=r.pointerId,e.setPointerCapture(r.pointerId),e.style.cursor=`grabbing`,(i=t.onInteraction)==null||i.call(t),r.preventDefault()))}function we(e){if(I!==e.pointerId||m.paused)return;let t=xe(e);t&&u.pointerMove(t.x-L.x,t.y-L.y)}function Te(e){I===e.pointerId&&Se()}function Ee(e){e.cancelable&&e.preventDefault()}function De(){Se(),ce=0,be(),document.hidden?cancelAnimationFrame(se):!z&&!oe&&(se=requestAnimationFrame(je))}function Oe(e){var n;e.preventDefault(),oe=!0,Se(),cancelAnimationFrame(se),(n=t.onError)==null||n.call(t,`描画が中断されました。「もう一度試す」で水滴を戻せます。`)}function B(){var e;(e=t.onError)==null||e.call(t,`描画の準備が戻りました。「もう一度試す」で再開してください。`)}function ke(t){let n=u.snapshot,{stretch:r,squash:i,angle:a}=d.update(n,t,m.reducedMotion),o=f.update(n,t,m.reducedMotion),s=m.refinement===`refined`,c=p.update({...n,grabPoint:R},t,m.reducedMotion||!s),h=s?nu(r,i,c.press):{x:1+r,y:1-r*.46+i,z:1-r*.34-i*.5},g=n.r*au;j.position.set((n.x-u.width/2)*au,(u.height/2-n.y)*au,0),A.rotation.z=a,A.scale.set(g*h.x,g*h.y,g*h.z);let _=o.strength*.5,v=o.strength>0?o.x/o.strength:0,y=o.strength>0?o.y/o.strength:0;M.matrix.set(1+_*v*v,_*v*y,0,o.x*g*.5,_*v*y,1+_*y*y,0,o.y*g*.5,0,0,1/(1+_),0,0,0,0,1);let E=Math.cos(a),O=Math.sin(a),k=s?(E*c.bendX+O*c.bendY)/h.x:0,P=s?(-O*c.bendX+E*c.bendY)/h.y:0,ne=Math.hypot(k,P),re=ne<1e-6?0:ne>.065?Wl/ne:1,ie=k*re,ae=P*re,F=s||m.reducedMotion?0:r*su.taperRatio;if(_e!==m.refinement||!Number.isFinite(me)||Math.abs(F-me)>1e-5||Math.abs(ie-he)+Math.abs(ae-ge)>1e-6||ie===0&&ae===0&&(he!==0||ge!==0)){me=F,he=ie,ge=ae,_e=m.refinement;for(let e=0;e<x.count;e++){let t=e*3,n=S[t],r=S[t+1],i=S[t+2];if(s){let a=i-Tl;x.setXYZ(e,n+ie*a*a,r+ae*a*a,i);let o=w[t],s=w[t+1],c=w[t+2]-2*a*(ie*o+ae*s),l=Math.hypot(o,s,c)||1;C.setXYZ(e,o/l,s/l,c/l)}else{let t=Math.max(0,i)*n;x.setXYZ(e,n+F*i*i,r*(1-F*n*.4),i*(1+F*t*.3))}}x.needsUpdate=!0,s?C.needsUpdate=!0:b.computeVertexNormals(),D.uniforms.uSurfaceBend.value.set(ie,ae)}N.matrix.makeTranslation(j.position.x,j.position.y,0).multiply(M.matrix),ee.rotation.z=te.rotation.z=a,ee.scale.set(g*h.x,g*h.y,1),te.scale.copy(ee.scale),T.thickness=su.thickness*(n.r/68)*(s?h.z:1-i*.5);let I=new J(0,0,g*.48).applyMatrix4(M.matrix).add(j.position).project(l),L=e.getBoundingClientRect();e.dataset.drop=JSON.stringify({x:n.x,y:n.y,vx:n.vx,vy:n.vy,mass:n.mass,grabbed:n.grabbed,screenX:(I.x+1)*L.width/2,screenY:(1-I.y)*L.height/2,radius:n.r,stretch:r,squash:i,hue:n.hue,pullX:o.x,pullY:o.y,pullStrength:o.strength,pointerGap:n.pointer?Math.hypot(n.pointer.x-n.x,n.pointer.y-n.y):0,refinement:m.refinement,clay:m.clay,bendX:ie,bendY:ae,press:c.press,scaleX:h.x,scaleY:h.y,scaleZ:h.z,affineVolume:h.x*h.y*h.z})}function Ae(){if(a.info.autoReset=!1,a.info.reset(),!k&&!m.clay){j.updateMatrixWorld(!0),l.updateMatrixWorld(!0),D.uniforms.uDropToWorld.value.copy(A.matrixWorld),D.uniforms.uWorldToDrop.value.copy(A.matrixWorld).invert(),D.uniforms.uViewProjection.value.multiplyMatrices(l.projectionMatrix,l.matrixWorldInverse);let e=a.toneMapping;j.visible=!1,a.toneMapping=0,a.setRenderTarget(E),a.render(s,l),a.setRenderTarget(null),a.toneMapping=e,j.visible=!0}a.render(s,l)}function je(r){if(z||oe||document.hidden)return;let i=ce?r-ce:0,o=Math.min(i/1e3,1/12);if(ce=r,!m.paused){u.tick(o),ke(o),ve+=o;let e=u.snapshot;n&&o>0&&n.contact(1,Math.hypot(e.wallImpulse.x,e.wallImpulse.y),e.r,e.x,u.width,`wall`,ve)}if(Ae(),i>0&&!m.paused){ue.push(i),ue.length>240&&ue.shift(),de||(de=r);let t=r-de;if(t>=3e4&&t<15e4&&fe.push(i),t>=15e4&&!pe){let t=[...fe].sort((e,t)=>e-t);e.dataset.benchmark=JSON.stringify({warmupSeconds:30,measurementSeconds:120,samples:t.length,medianMs:t[Math.floor(t.length*.5)],p95Ms:t[Math.floor(t.length*.95)],over50ms:t.filter(e=>e>50).length,quality:m.quality,lighting:m.lighting,inspection:m.inspection,dpr:a.getPixelRatio(),drawingBuffer:{width:e.width,height:e.height},userAgent:navigator.userAgent,source:`requestAnimationFrame intervals; not GPU time or input latency`}),pe=!0}}if(r-le>500&&ue.length){var s;le=r;let i=[...ue].sort((e,t)=>e-t),o=i[Math.floor(i.length/2)],c=i[Math.floor(i.length*.95)];(s=t.onStats)==null||s.call(t,{fps:Math.round(1e3/o),frameP95:Math.round(c*10)/10,grabbed:u.snapshot.grabbed}),e.dataset.renderStats=JSON.stringify({medianMs:o,p95Ms:c,calls:a.info.render.calls,triangles:a.info.render.triangles,textures:a.info.memory.textures,geometries:a.info.memory.geometries,width:e.width,height:e.height,quality:m.quality}),n&&(e.dataset.sensory=JSON.stringify(n.status()))}se=requestAnimationFrame(je)}e.style.touchAction=`none`,e.style.cursor=`grab`,e.addEventListener(`pointerdown`,Ce),e.addEventListener(`pointermove`,we),e.addEventListener(`pointerup`,Te),e.addEventListener(`pointercancel`,Te),e.addEventListener(`lostpointercapture`,Te),e.addEventListener(`touchstart`,Ee,{passive:!1}),e.addEventListener(`touchmove`,Ee,{passive:!1}),e.addEventListener(`webglcontextlost`,Oe),e.addEventListener(`webglcontextrestored`,B),window.addEventListener(`blur`,Se),document.addEventListener(`visibilitychange`,De);let V=new ResizeObserver(ye);return V.observe(e),ye(),ke(0),Ae(),se=requestAnimationFrame(je),(r=t.onReady)==null||r.call(t),{setOptions(e){if(z)return;let t=e.lighting!==void 0&&e.lighting!==m.lighting,n=e.quality!==void 0&&e.quality!==m.quality,r=e.refinement!==void 0&&e.refinement!==m.refinement,i=e.clay!==void 0&&e.clay!==m.clay;if(Object.assign(m,e),u.setHue(m.hue),T.attenuationColor.set(iu[m.hue]),D.uniforms.uTint.value.set(iu[m.hue]),D.uniforms.uDaylight.value=+(m.lighting===`daylight`),te.material.uniforms.color.value.set(iu[m.hue]),A.material=m.clay?O:k?T:D,te.visible=!m.clay,g.map=h[+!!m.inspection],g.bumpMap=m.inspection?null:h[0],g.needsUpdate=!0,t){let e=c;c=lu(a,m.lighting===`daylight`),s.environment=c.texture,e.dispose(),g.color.set(m.lighting===`daylight`?`#c6c9c2`:`#455157`),v.intensity=m.lighting===`daylight`?1.35:1,a.toneMappingExposure=m.lighting===`daylight`?1.13:su.exposure}n&&ye(),m.paused&&Se(),r?(p.reset(),ke(0)):i&&ke(0),m.reducedMotion&&(d.reset(),f.reset(),p.reset(),ke(0)),ce=0,be()},reset(){Se(),u.reset(),d.reset(),f.reset(),p.reset(),ke(0),be(),ce=0},dispose(){z||(Se(),z=!0,cancelAnimationFrame(se),V.disconnect(),e.removeEventListener(`pointerdown`,Ce),e.removeEventListener(`pointermove`,we),e.removeEventListener(`pointerup`,Te),e.removeEventListener(`pointercancel`,Te),e.removeEventListener(`lostpointercapture`,Te),e.removeEventListener(`touchstart`,Ee),e.removeEventListener(`touchmove`,Ee),e.removeEventListener(`webglcontextlost`,Oe),e.removeEventListener(`webglcontextrestored`,B),window.removeEventListener(`blur`,Se),document.removeEventListener(`visibilitychange`,De),s.traverse(e=>{(e instanceof ui||e instanceof Ei)&&(e.geometry.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose()))}),h.forEach(e=>e.dispose()),c.dispose(),E.dispose(),k?D.dispose():T.dispose(),O.dispose(),m.clay&&(D.dispose(),T.dispose()),a.dispose())}}}var pu=r(i(),1),mu=.8,hu=.17,gu=3.5,_u=3;function vu(){var e;let t=typeof window<`u`?(e=window.AudioContext)==null?window.webkitAudioContext:e:void 0;return t?new t({latencyHint:`interactive`}):null}function yu(e){let t=1.2,n=Math.floor(e.sampleRate*t),r=e.createBuffer(2,n,e.sampleRate),i=24301;for(let a=0;a<2;a++){let o=r.getChannelData(a),s=0;for(let r=0;r<n;r++){i=Math.imul(i,1664525)+1013904223|0;let n=(i>>>0)/4294967296*2-1,a=r/e.sampleRate,c=.55-.45*Math.min(1,a/t);s+=(n-s)*c,o[r]=s*Math.exp(-a/.3)*(a<.008?a/.008:1)}}return r}function bu(e=vu){let t=null,n=null,r=null,i=null,a=!0,o=!1;function s(){if(o)return null;if(t)return t;try{t=e()}catch(e){t=null}if(!t)return null;r=t.createGain(),r.gain.value=a?mu:0;let s=t.createDynamicsCompressor();s.threshold.value=-11,s.knee.value=6,s.ratio.value=12,s.attack.value=.002,s.release.value=.15,n=t.createGain();let c=t.createConvolver();c.buffer=yu(t);let l=t.createGain();l.gain.value=hu,n.connect(s),n.connect(c),c.connect(l),l.connect(s),s.connect(r),r.connect(t.destination);let u=Math.floor(t.sampleRate*.25);i=t.createBuffer(1,u,t.sampleRate);let d=i.getChannelData(0),f=4660;for(let e=0;e<u;e++)f=Math.imul(f,1664525)+1013904223|0,d[e]=(f>>>0)/4294967296*2-1;return t}function c(){return!a||!t||!n||!(typeof OfflineAudioContext<`u`&&t instanceof OfflineAudioContext)&&t.state!==`running`?null:t}function l(e,t,r,i=gu){let a=e.createGain();a.gain.value=i;let o=a;if(typeof e.createStereoPanner==`function`&&t){let n=e.createStereoPanner();n.pan.value=t,a.connect(n),o=n}o.connect(n);let s=e.createConstantSource();return s.offset.value=0,s.connect(a),s.start(e.currentTime),s.stop(e.currentTime+r+.1),s.onended=()=>{s.disconnect(),a.disconnect(),o!==a&&o.disconnect()},a}function u(e,t,n){var r,i,a,o;let s=e.currentTime+((r=n.start)==null?0:r),c=e.createOscillator(),l=e.createGain();c.type=(i=n.type)==null?`sine`:i,c.frequency.setValueAtTime(n.frequency,s),n.to&&c.frequency.exponentialRampToValueAtTime(Math.max(20,n.to),s+((a=n.glide)==null?n.decay:a));let u=(o=n.attack)==null?.004:o;l.gain.setValueAtTime(1e-4,s),l.gain.exponentialRampToValueAtTime(Math.max(2e-4,n.gain),s+u),l.gain.exponentialRampToValueAtTime(1e-4,s+u+n.decay),c.connect(l),l.connect(t),c.start(s),c.stop(s+u+n.decay+.02),c.onended=()=>{c.disconnect(),l.disconnect()}}function d(e,t,n){var r,a;if(!i)return;let o=e.currentTime+((r=n.start)==null?0:r),s=e.createBufferSource();s.buffer=i;let c=e.createBiquadFilter();c.type=n.type,c.frequency.setValueAtTime(n.frequency,o),n.to&&c.frequency.exponentialRampToValueAtTime(n.to,o+n.decay),c.Q.value=(a=n.q)==null?.7:a;let l=e.createGain();l.gain.setValueAtTime(n.gain,o),l.gain.exponentialRampToValueAtTime(1e-4,o+n.decay),s.connect(c),c.connect(l),l.connect(t),s.start(o),s.stop(o+n.decay+.02),s.onended=()=>{s.disconnect(),c.disconnect(),l.disconnect()}}let f=()=>1+(Math.random()-.5)*.06;return{get context(){return t},unlock(){let e=s();e&&`resume`in e&&e.state===`suspended`&&e.resume().catch(()=>void 0)},setEnabled(e){a=e,r&&t&&r.gain.setTargetAtTime(e?mu:0,t.currentTime,.03)},touch(e,t){let n=c();if(!n)return;let r=l(n,t,.3),i=300*e*f();u(n,r,{frequency:i,to:i*1.35,glide:.035,decay:.085,gain:.07}),u(n,r,{frequency:i*.5,decay:.05,gain:.035}),d(n,r,{type:`lowpass`,frequency:1400,decay:.018,gain:.018})},impact(e,t,n,r){let i=c();if(!i)return;let a=l(i,r,.35),o=(n===`drop`?230:165)*t*f();u(i,a,{frequency:o,to:o*.72,decay:.11+.05*e,gain:.16*e}),d(i,a,{type:`lowpass`,frequency:700+500*e,decay:.03,gain:.05*e}),n===`obstacle`&&(d(i,a,{type:`bandpass`,frequency:2300,q:3,decay:.022,gain:.05*e}),u(i,a,{frequency:o*3.1,decay:.05,gain:.02*e}))},fusion(e,t,n,r){let i=c();if(!i)return;let a=l(i,r,.9),o=390*t*(.9+.1*n)*f();u(i,a,{frequency:o,to:o*(1.55+.25*n),glide:.065,decay:.2,gain:.13*e}),u(i,a,{frequency:o*.5,to:o*.42,decay:.07,gain:.07*e}),d(i,a,{type:`lowpass`,frequency:900,decay:.03,gain:.03*e}),n>=1?u(i,a,{frequency:o*2.01,start:.04,attack:.02,decay:.55,gain:.022*e}):u(i,a,{frequency:o*.94,to:o*1.2,glide:.08,decay:.24,gain:.07*(1-n)*e,type:`triangle`})},chime(e,t,n=1){let r=c();if(!r)return;let i=l(r,0,2.4+t.length*.2,_u),a=[[1,1,1.7],[2,.28,1],[2.76,.2,.7],[5.4,.07,.35]];t.forEach((t,o)=>{for(let[s,c,l]of a)u(r,i,{frequency:e*t*s,start:o*.14,attack:.006,decay:l,gain:.055*c*n})})},rewind(){let e=c();if(!e)return;let t=l(e,0,.3,3);d(e,t,{type:`bandpass`,frequency:2200,to:450,q:1.4,decay:.14,gain:.05}),u(e,t,{frequency:520,to:330,decay:.1,gain:.03})},dispose(){o=!0;let e=t;t=null,n=null,r=null,e&&`close`in e&&e.close().catch(()=>void 0)}}}var xu=44,Su=(e,t,n)=>Math.max(t,Math.min(n,e));function Cu(e){return!Number.isFinite(e)||e<=0?1:Su(Math.cbrt(xu/e),.62,1.45)}function wu(e,t){return!Number.isFinite(e)||!Number.isFinite(t)||t<=0?0:Su((e/t-.5)*.7,-.35,.35)}function Tu(e,t,n){if(!Number.isFinite(e)||e<70)return null;let r=Su((e-70)/880,0,1);return{gain:.18+.82*r**.6,size:Cu(t),surface:n,haptic:Math.round(5+13*r)}}function Eu(e,t){let n=Number.isFinite(t)?Su(t,.5,1):1,r=n>=.995?1:Su((n-.5)/.5,0,1)*.6;return{gain:.85+.15*r,size:Cu(e),clarity:r,haptic:r===1?[12]:[8,45,8]}}var Du=class{constructor(){a(this,`lastContact`,new Map)}onset(e,t){let n=this.lastContact.get(e);if(this.lastContact.set(e,t),this.lastContact.size>64)for(let e of[...this.lastContact.keys()].slice(0,this.lastContact.size-64))this.lastContact.delete(e);return n===void 0||t-n>=.12}reset(){this.lastContact.clear()}},Ou=45;function ku(e){var t,n,r;if(!e)return`none`;let i=((t=e.maxTouchPoints)==null?0:t)>0;if(typeof e.vibrate==`function`)return i?`vibrate`:`none`;let a=(n=e.userAgent)==null?``:n;return/iPhone|iPod|iPad/.test(a)||/Macintosh/.test(a)&&((r=e.maxTouchPoints)==null?0:r)>1?`ios-switch`:`none`}function Au(){let e=typeof navigator>`u`?`none`:ku(navigator),t=!0,n=-1/0,r=null;function i(){if(r||typeof document>`u`||!document.body)return r;r=document.createElement(`label`),r.setAttribute(`aria-hidden`,`true`),r.style.cssText=`position:fixed;left:-200px;top:0;width:1px;height:1px;overflow:hidden;opacity:0;pointer-events:none;`;let e=document.createElement(`input`);return e.type=`checkbox`,e.setAttribute(`switch`,``),e.tabIndex=-1,r.appendChild(e),document.body.appendChild(r),r}return{mode:e,setEnabled(e){t=e},pulse(r){if(!t||e===`none`)return;let a=typeof performance<`u`?performance.now():Date.now();if(!(a-n<Ou)){n=a;try{if(e===`vibrate`)navigator.vibrate(r);else{let e=document.activeElement,t=i();t==null||t.click(),t&&document.activeElement===t.firstElementChild&&e instanceof HTMLElement&&e.focus({preventScroll:!0})}}catch(e){}}},dispose(){r==null||r.remove(),r=null}}}var ju=`pura-flow-sensory-v1`;function Mu(e,t){let n={sound:!0,haptics:!0};try{let t=(e==null?window.localStorage:e).getItem(ju),r=t?JSON.parse(t):null;(r==null?void 0:r.v)===1&&(typeof r.sound==`boolean`&&(n.sound=r.sound),typeof r.haptics==`boolean`&&(n.haptics=r.haptics))}catch(e){}try{let e=new URLSearchParams(t==null?window.location.search:t);e.get(`sound`)===`off`&&(n.sound=!1),e.get(`haptics`)===`off`&&(n.haptics=!1)}catch(e){}return n}function Nu(e,t){try{return(t==null?window.localStorage:t).setItem(ju,JSON.stringify({v:1,...e})),!0}catch(e){return!1}}var Pu={cyan:784,rose:659.3,amber:587.3};function Fu(e={}){var t,n;let r=(t=e.audio)==null?bu():t,i=(n=e.haptics)==null?Au():n,a=new Du,o={grab:0,impact:0,fusion:0,ready:0,delivered:0,rewind:0},s=!0,c=()=>{s&&r.unlock()},l=[`pointerdown`,`pointerup`,`touchend`,`keydown`];if(typeof window<`u`)for(let e of l)window.addEventListener(e,c,{capture:!0,passive:!0});return{hapticMode:i.mode,unlock:c,setPreferences(e){s=e.sound,r.setEnabled(e.sound),i.setEnabled(e.haptics)},grab(e,t,n){o.grab++,r.touch(Cu(e),wu(t,n)),i.pulse(8)},contact(e,t,n,s,c,l,u){if(!(t>0)||!a.onset(e,u))return;let d=Tu(t,n,l);d&&(o.impact++,r.impact(d.gain,d.size,d.surface,wu(s,c)),i.pulse(d.haptic))},fusion(e,t,n,a){let s=Eu(e,a);o.fusion++,r.fusion(s.gain,s.size,s.clarity,wu(t,n)),i.pulse(s.haptic)},ready(e){var t;o.ready++,r.chime((t=Pu[e])==null?700:t,[1],.5),i.pulse(10)},delivered(e,t){var n;o.delivered++;let a=(n=Pu[e])==null?700:n;r.chime(a,t?[1,1.25,1.5,2]:[1,1.5],.5),i.pulse(t?[18,70,18,70,26]:[18,70,24])},rewind(){o.rewind++,r.rewind(),i.pulse(6)},status(){var e;let t=r.context;return{audio:(e=t==null?void 0:t.state)==null?`idle`:e,haptics:i.mode,counts:{...o}}},dispose(){if(typeof window<`u`)for(let e of l)window.removeEventListener(e,c,{capture:!0});r.dispose(),i.dispose()}}}function Iu(){let[e]=(0,pu.useState)(()=>Fu()),[t,n]=(0,pu.useState)(()=>Mu());return(0,pu.useEffect)(()=>{e.setPreferences(t)},[e,t]),(0,pu.useEffect)(()=>()=>e.dispose(),[e]),{feedback:e,preferences:t,change:r=>{let i={...t,...r};Nu(i),e.setPreferences(i),i.sound&&!t.sound&&e.unlock(),n(i)}}}export{Ii as A,sn as B,Bt as C,Yi as D,Qr as E,Mr as F,Ri as I,q as L,Li as M,Xe as N,ja as O,Kn as P,J as R,ya as S,ui as T,c as V,Z as _,cu as a,Rn as b,nu as c,Ol as d,bl as f,Fi as g,Ai as h,fu as i,Qa as j,Wr as k,Ul as l,Br as m,du as n,lu as o,Tr as p,uu as r,ru as s,Iu as t,Il as u,Pa as v,un as w,P as x,nt as y,an as z};