...
void main() {
	...
	`}var Uo=class extends gn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ri(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function Fl(e){return new ea({name:`Pura two-interface liquid`,uniforms:{uBackground:{value:e},uViewProjection:{value:new yn},uWorldToDrop:{value:new yn},uDropToWorld:{value:new yn},uTint:{value:new X(`#5dd7e7`)},uDaylight:{value:0},uIor:{value:1.333},uSurfaceBend:{value:new K}},depthWrite:!0,toneMapped:!0,vertexShader:`
    ...
    `})}var Il=Math.PI*2*3.1,Ll=3.4,Rl=Math.sqrt(Il*Il-Ll*Ll),zl=1/12,Bl=.26,Vl=.25,Hl=(e,t,n)=>Math.max(t,Math.min(n,e)),Ul=class{constructor(){l(this,`stretch`,0),l(this,`stretchVelocity`,0),l(this,`squash`,0),l(this,`angle`,0),l(this,`previousVx`,0),l(this,`previousVy`,0),l(this,`previousGrabbed`,!1)}get snapshot(){return{stretch:this.stretch,squash:this.squash,angle:this.angle}}reset(){this.stretch=this.stretchVelocity=this.squash=this.angle=0,this.previousVx=this.previousVy=0,this.previousGrabbed=!1}update(e,t,n=!1){if(n)return this.reset(),this.observe(e),this.snapshot;if(!Number.isFinite(t)||t<=0)return this.snapshot;let r=Math.min(t,zl),i=Math.hypot(e.vx,e.vy),a=Math.hypot(this.previousVx,this.previousVy),o=Math.hypot(e.wallImpulse.x,e.wallImpulse.y),s=i-a,c=Math.hypot(e.vx-this.previousVx,e.vy-this.previousVy),l=Math.max(0,c-Math.abs(s)),u=Math.min(.026,i/32e3)+(o>0?0:Hl(s*.006+l*.003,-5,5))/(Il*Il*r);this.previousGrabbed&&!e.grabbed&&(i>20||Math.abs(this.stretch)>.006)&&(this.stretchVelocity-=Math.min(2.7,.9+i/650+Math.abs(this.stretch)*3)),o>0&&(this.stretchVelocity-=Math.min(5,o*.0045),this.squash=Math.min(Vl,this.squash+o/7e3)),this.stretchVelocity=Hl(this.stretchVelocity,-7,7);let d=this.stretch-u,f=Math.exp(-3.4*r),p=Math.cos(Rl*r),m=Math.sin(Rl*r),h=this.stretchVelocity;this.stretch=u+f*(d*p+(h+Ll*d)/Rl*m),this.stretchVelocity=f*(h*p-(Ll*h+Il*Il*d)/Rl*m);let g=Hl(this.stretch,-.26,Bl);if(g!==this.stretch&&(this.stretch=g,this.stretch*this.stretchVelocity>0&&(this.stretchVelocity=0)),this.squash*=Math.exp(-r*9),i>10||o>0){let t=o>0?Math.atan2(-e.wallImpulse.y,e.wallImpulse.x):Math.atan2(-e.vy,e.vx),n=Math.atan2(Math.sin((t-this.angle)*2),Math.cos((t-this.angle)*2))/2;this.angle+=n*(1-Math.exp(-r*15))}return this.observe(e),this.snapshot}observe(e){this.previousVx=e.vx,this.previousVy=e.vy,this.previousGrabbed=e.grabbed}},Wl=1/12,Gl=.24,Kl=.03,ql=.4,Jl=.045,Yl=.065,Xl=class{constructor(){l(this,`x`,0),l(this,`y`,0)}get snapshot(){return{x:this.x,y:this.y,strength:Math.hypot(this.x,this.y)}}reset(){this.x=this.y=0}update(e,t,n=!1){if(n)return this.reset(),this.snapshot;if(!Number.isFinite(t)||t<=0)return this.snapshot;let r=Math.min(t,Wl),i=0,a=0;if(e.grabbed&&e.pointer&&Number.isFinite(e.r)&&e.r>0){let t=(e.pointer.x-e.x)/e.r,n=-(e.pointer.y-e.y)/e.r,r=Math.hypot(t,n);if(Number.isFinite(r)&&r>Kl){let e=Math.min(Gl,(r-Kl)*ql);i=t/r*e,a=n/r*e}}let o=i===0&&a===0,s=-Math.expm1(-r/(o?Yl:Jl));return this.x+=(i-this.x)*s,this.y+=(a-this.y)*s,this.snapshot}},Zl=.065,Ql=.028,$l=1/12,eu=.03,tu=.105,nu=.018,ru=.085,iu=.08,au=.065,ou=.01,su=(e,t,n)=>Math.max(t,Math.min(n,e)),cu=(e,t,n)=>Number.isFinite(e)?su(e,t,n):0;function lu(e,t,n){let r=cu(e,-.26,.26),i=cu(t,0,.25),a=Math.sqrt(1+cu(n,0,Ql)),o=(1+r)*a,s=(1-r*.46+i)*a;return{x:o,y:s,z:1/(o*s)}}var uu=class{constructor(){l(this,`bendX`,0),l(this,`bendY`,0),l(this,`edgeX`,0),l(this,`edgeY`,0),l(this,`press`,0),l(this,`previousGrabbed`,!1)}get snapshot(){let e=this.bendX+this.edgeX,t=this.bendY+this.edgeY,n=Math.hypot(e,t),r=n>.065?Zl/n:1;return{bendX:e*r,bendY:t*r,press:this.press}}reset(){this.bendX=this.bendY=this.edgeX=this.edgeY=this.press=0,this.previousGrabbed=!1}update(e,t,n=!1){if(n)return this.reset(),this.previousGrabbed=e.grabbed,this.snapshot;if(!Number.isFinite(t)||t<=0)return this.snapshot;let r=Math.min(t,$l);if(e.grabbed&&!this.previousGrabbed){this.press=Ql;let t=e.grabPoint,n=t&&Number.isFinite(t.x)?t.x:0,r=t&&Number.isFinite(t.y)?t.y:0,i=ou/Math.max(1,Math.hypot(n,r));this.edgeX=n*i,this.edgeY=r*i}let i=0,a=0;if(e.grabbed&&e.pointer&&Number.isFinite(e.r)&&e.r>0){let t=(e.pointer.x-e.x)/e.r,n=-(e.pointer.y-e.y)/e.r,r=Math.hypot(t,n);if(Number.isFinite(r)&&r>eu){let e=Math.min(Zl,(r-eu)*tu);i=t/r*e,a=n/r*e}}let o=i===0&&a===0,s=-Math.expm1(-r/(o?ru:nu));return this.bendX+=(i-this.bendX)*s,this.bendY+=(a-this.bendY)*s,this.edgeX*=Math.exp(-r/au),this.edgeY*=Math.exp(-r/au),this.press*=Math.exp(-r/iu),this.previousGrabbed=e.grabbed,this.snapshot}},du={cyan:`#5dd7e7`,rose:`#eb729e`,amber:`#f5bc54`},fu=.01,pu=.47,mu={roughness:.035,ior:1.333,absorptionDistance:2.6,thickness:1.05,exposure:1.05,maxStretch:.26,maxSquash:.25,taperRatio:.16};function hu(e){let t=document.createElement(`canvas`);t.width=t.height=1024;let n=t.getContext(`2d`);if(e){n.fillStyle=`#909598`,n.fillRect(0,0,1024,1024);for(let e=0;e<16;e++)for(let t=0;t<16;t++)(t+e)%2&&(n.fillStyle=`#575e63`,n.fillRect(t*64,e*64,64,64)),n.fillStyle=`#d8ddd9`,n.fillRect(t*64+30,e*64+25,1,12),n.fillRect(t*64+25,e*64+30,12,1)}else{let e=n.createImageData(1024,1024),t=127;for(let n=0;n<1024;n++)for(let r=0;r<1024;r++){t=Math.imul(t,1664525)+1013904223|0;let i=(t>>>0)/4294967296,a=Math.sin(r*.012+Math.sin(n*.009)*3)*3,o=i>.997?12:0,s=127+(i-.5)*9+a+o,c=(n*1024+r)*4;e.data[c]=s,e.data[c+1]=s+2,e.data[c+2]=s+4,e.data[c+3]=255}n.putImageData(e,0,0)}let r=new zi(t);return r.colorSpace=ot,r.wrapS=r.wrapT=D,r.repeat.set(3,3),r}function gu(e,t){let n=new tr;n.add(new yi(new Ui(30,30,30),new si({color:t?`#83949a`:`#343d49`,side:1})));function r(e,t,r,i,a,o){let s=new yi(new Wi(e,t),new si({color:new X(...o),side:2}));s.position.set(r,i,a),s.lookAt(0,0,0),n.add(s)}r(7.5,2.3,-3,3.6,5,t?[22,22,20]:[20,22,24]),r(.85,5.2,4.5,.5,3.5,[18,21,24]),r(4.5,.65,0,-4.5,.65,[13,15,18]),r(3.2,1.7,-3.2,-3.8,1.6,t?[3,2.8,2.3]:[1.4,1.5,1.6]),r(1.3,3,.8,5.5,.7,[.9,1.1,1.25]);let i=new Po(e),a=i.fromScene(n,.035,.1,60);return i.dispose(),n.traverse(e=>{e instanceof yi&&(e.geometry.dispose(),e.material.dispose())}),a}function _u(){return new ea({transparent:!0,depthWrite:!1,uniforms:{color:{value:new X(du.cyan)},gain:{value:1}},vertexShader:`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`
      ...
      }`})}function vu(){return new ea({transparent:!0,depthWrite:!1,blending:2,uniforms:{color:{value:new X(du.cyan)},gain:{value:.34}},vertexShader:`varying vec2 vUv; void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}`,fragmentShader:`
      varying vec2 vUv; uniform vec3 color; uniform float gain;
      void main(){
      ...
      }`})}function yu(e,t={}){var n;let r=e.getContext(`webgl2`,{alpha:!1,antialias:!0,powerPreference:`high-performance`});if(!r)throw Error(`このブラウザでは水滴の描画を開始できません。WebGL 2対応のブラウザでお試しください。`);let i=new Dl({canvas:e,context:r,antialias:!0});i.outputColorSpace=ot,i.toneMapping=4,i.toneMappingExposure=mu.exposure;let a=r.getExtension(`WEBGL_debug_renderer_info`);e.dataset.environment=JSON.stringify({userAgent:navigator.userAgent,webgl:r.getParameter(r.VERSION),renderer:a?r.getParameter(a.UNMASKED_RENDERER_WEBGL):r.getParameter(r.RENDERER),color:`linear render targets / ACES / sRGB output`});let o=new tr;o.background=new X(`#171e24`);let s=gu(i,!1);o.environment=s.texture;let c=new Ra(34,1,.1,100);c.up.set(0,1,0);let l=new jl({radius:88}),u=new Ul,d=new Xl,f=new uu,p={hue:`cyan`,lighting:`studio`,inspection:!1,reducedMotion:!1,paused:!1,quality:`high`,refinement:`refined`,clay:!1},m=[hu(!1),hu(!0)];for(let e of m)e.anisotropy=Math.min(8,i.capabilities.getMaxAnisotropy());let h=new na({color:`#455157`,map:m[0],roughness:.52,metalness:.12,envMapIntensity:.08,bumpMap:m[0],bumpScale:.004}),g=new yi(new Wi(40,40),h);g.position.z=-.012,o.add(g);let _=new Ea(`#c9d8e2`,`#41454a`,1),v=new Va(`#ebf3fa`,1.35);v.position.set(-4,4,8),o.add(_,v);let y=new Gi(1,96,64),b=y.getAttribute(`position`);for(let e=0;e<b.count;e++){let t=b.getZ(e);b.setZ(e,Math.max(.007,(t+.64)*.62))}y.computeVertexNormals(),y.boundingSphere=new Vr(new q(0,0,.5),1.16);let x=new Float32Array(b.array),S=y.getAttribute(`normal`),C=new Float32Array(S.array),w=new ra({color:`#ffffff`,metalness:0,roughness:mu.roughness,transmission:1,thickness:mu.thickness,ior:mu.ior,attenuationColor:du.cyan,attenuationDistance:mu.absorptionDistance,envMapIntensity:1.55,dispersion:.012}),T=new gn(1,1,{type:R});T.texture.colorSpace=``;let E=Fl(T.texture),D=new na({color:`#aab6b5`,roughness:.7,metalness:0,envMapIntensity:.45}),O=new URLSearchParams(location.search).get(`material`)===`physical`,k=new yi(y,O?w:E);k.frustumCulled=!1;let A=new qn,j=new qn;j.matrixAutoUpdate=!1,j.add(k),A.add(j),o.add(A);let M=new qn;M.matrixAutoUpdate=!1,o.add(M);let N=new yi(new Wi(4,4),_u());N.position.z=-.003,M.add(N);let P=new yi(new Wi(4,4),vu());P.position.z=-.001,M.add(P);let F=new Li(new Yr,new Di({color:`#9baeb7`,transparent:!0,opacity:.085}));F.position.z=.001,o.add(F);let I=new ao,ee=new K,te=new $r(new q(0,0,1),0),ne=new q,L=null,re=new K,ie=new K,ae=!1,oe=!1,se=0,ce=0,le=0,ue=[],de=0,fe=[],pe=!1,me=NaN,he=NaN,ge=NaN,_e=``;function ve(){if(ae||oe)return;let t=e.getBoundingClientRect();if(t.width<1||t.height<1)return;xe(),i.setPixelRatio(Math.min(devicePixelRatio||1,p.quality===`high`?2:1.25)),i.setSize(t.width,t.height,!1),i.transmissionResolutionScale=p.quality===`high`?1:.6;let n=p.quality===`high`?1:.7;T.setSize(Math.max(1,Math.round(e.width*n)),Math.max(1,Math.round(e.height*n)));let r=t.width/t.height,a=Yt.clamp(t.width*1.06,550,1200),o=a/r;l.resize(a,o),c.aspect=r;let s=l.snapshot.r*fu,u=Math.max(22,Math.min(l.width,l.height)*.04)*fu,d=(1+.64)*.62,f=mu.maxStretch*mu.taperRatio,m=Math.max(1+mu.maxStretch,1+mu.maxStretch*.46+mu.maxSquash)*Math.sqrt(1+Ql),h=Math.max(f*Math.hypot(d*d,.4),Zl*(Nl-Ml)**2),g=1+Gl*.5,_=s*Gl*.5,v=s*m*g,y=Math.max(1+mu.maxStretch*.34,lu(-mu.maxStretch,0,0).z),b=Math.min(1-mu.maxStretch*.34-mu.maxSquash*.5,lu(mu.maxStretch,mu.maxSquash,Ql).z)/g,x=v*h,S=s*y*d*d*f*.3,C=l.width*fu*.5-u-s,w=l.height*fu*.5-u-s,E=Math.sin(pu),D=Math.cos(pu),O=Math.tan(Yt.degToRad(c.fov*.5)),k=.97,A=0,j=1/(O*r*k),M=1/(O*k);for(let[e,t,n]of[[j,-E,D],[-j,-E,D],[0,D*M-E,E*M+D],[0,-D*M-E,-E*M+D]]){let r=Math.hypot(e,t),i=n>=0?y:b,a=Math.hypot(r*v,n*s*.62*i)+n*s*.3968*i+r*(x+_)+Math.abs(n)*S;A=Math.max(A,Math.abs(e)*C+Math.abs(t)*w+a)}c.position.set(0,-Math.sin(pu)*A,Math.cos(pu)*A),c.lookAt(0,0,0),c.updateProjectionMatrix();let N=l.width*fu*.5-u,P=l.height*fu*.5-u;F.geometry.dispose(),F.geometry=new Yr().setFromPoints([new q(-N,-P,0),new q(N,-P,0),new q(N,P,0),new q(-N,P,0)]),ye()}function ye(){ue=[],fe=[],de=0,pe=!1,delete e.dataset.benchmark}function be(t){let n=e.getBoundingClientRect();return ee.set((t.clientX-n.left)/n.width*2-1,-(t.clientY-n.top)/n.height*2+1),I.setFromCamera(ee,c),I.ray.intersectPlane(te,ne)?{x:ne.x/fu+l.width*.5,y:l.height*.5-ne.y/fu}:null}function xe(){L!==null&&e.hasPointerCapture(L)&&e.releasePointerCapture(L),L=null,l.pointerUp(),e.style.cursor=`grab`}function Se(n){var r;if(p.paused||oe||L!==null||n.pointerType===`mouse`&&n.button!==0)return;let i=be(n);if(!i)return;A.updateMatrixWorld(!0);let a=I.intersectObject(k,!1)[0],o=l.snapshot;!a&&Math.hypot(i.x-o.x,i.y-o.y)>o.r+14||(re.set(i.x-o.x,i.y-o.y),a?ie.set((a.point.x-A.position.x)/(o.r*fu),(a.point.y-A.position.y)/(o.r*fu)):ie.set((i.x-o.x)/o.r,-(i.y-o.y)/o.r),ie.clampLength(0,1),l.pointerDown(o.x,o.y)&&(L=n.pointerId,e.setPointerCapture(n.pointerId),e.style.cursor=`grabbing`,(r=t.onInteraction)==null||r.call(t),n.preventDefault()))}function Ce(e){if(L!==e.pointerId||p.paused)return;let t=be(e);t&&l.pointerMove(t.x-re.x,t.y-re.y)}function we(e){L===e.pointerId&&xe()}function Te(e){e.cancelable&&e.preventDefault()}function Ee(){xe(),ce=0,ye(),document.hidden?cancelAnimationFrame(se):!ae&&!oe&&(se=requestAnimationFrame(Ae))}function De(e){var n;e.preventDefault(),oe=!0,xe(),cancelAnimationFrame(se),(n=t.onError)==null||n.call(t,`描画が中断されました。「もう一度試す」で水滴を戻せます。`)}function Oe(){var e;(e=t.onError)==null||e.call(t,`描画の準備が戻りました。「もう一度試す」で再開してください。`)}function ke(t){let n=l.snapshot,{stretch:r,squash:i,angle:a}=u.update(n,t,p.reducedMotion),o=d.update(n,t,p.reducedMotion),s=p.refinement===`refined`,m=f.update({...n,grabPoint:ie},t,p.reducedMotion||!s),h=s?lu(r,i,m.press):{x:1+r,y:1-r*.46+i,z:1-r*.34-i*.5},g=n.r*fu;A.position.set((n.x-l.width/2)*fu,(l.height/2-n.y)*fu,0),k.rotation.z=a,k.scale.set(g*h.x,g*h.y,g*h.z);let _=o.strength*.5,v=o.strength>0?o.x/o.strength:0,T=o.strength>0?o.y/o.strength:0;j.matrix.set(1+_*v*v,_*v*T,0,o.x*g*.5,_*v*T,1+_*T*T,0,o.y*g*.5,0,0,1/(1+_),0,0,0,0,1);let D=Math.cos(a),O=Math.sin(a),F=s?(D*m.bendX+O*m.bendY)/h.x:0,I=s?(-O*m.bendX+D*m.bendY)/h.y:0,ee=Math.hypot(F,I),te=ee<1e-6?0:ee>.065?Zl/ee:1,ne=F*te,L=I*te,re=s||p.reducedMotion?0:r*mu.taperRatio;if(_e!==p.refinement||!Number.isFinite(me)||Math.abs(re-me)>1e-5||Math.abs(ne-he)+Math.abs(L-ge)>1e-6||ne===0&&L===0&&(he!==0||ge!==0)){me=re,he=ne,ge=L,_e=p.refinement;for(let e=0;e<b.count;e++){let t=e*3,n=x[t],r=x[t+1],i=x[t+2];if(s){let a=i-Ml;b.setXYZ(e,n+ne*a*a,r+L*a*a,i);let o=C[t],s=C[t+1],c=C[t+2]-2*a*(ne*o+L*s),l=Math.hypot(o,s,c)||1;S.setXYZ(e,o/l,s/l,c/l)}else{let t=Math.max(0,i)*n;b.setXYZ(e,n+re*i*i,r*(1-re*n*.4),i*(1+re*t*.3))}}b.needsUpdate=!0,s?S.needsUpdate=!0:y.computeVertexNormals(),E.uniforms.uSurfaceBend.value.set(ne,L)}M.matrix.makeTranslation(A.position.x,A.position.y,0).multiply(j.matrix),N.rotation.z=P.rotation.z=a,N.scale.set(g*h.x,g*h.y,1),P.scale.copy(N.scale),w.thickness=mu.thickness*(n.r/68)*(s?h.z:1-i*.5);let R=new q(0,0,g*.48).applyMatrix4(j.matrix).add(A.position).project(c),ae=e.getBoundingClientRect();e.dataset.drop=JSON.stringify({x:n.x,y:n.y,vx:n.vx,vy:n.vy,mass:n.mass,grabbed:n.grabbed,screenX:(R.x+1)*ae.width/2,screenY:(1-R.y)*ae.height/2,radius:n.r,stretch:r,squash:i,hue:n.hue,pullX:o.x,pullY:o.y,pullStrength:o.strength,pointerGap:n.pointer?Math.hypot(n.pointer.x-n.x,n.pointer.y-n.y):0,refinement:p.refinement,clay:p.clay,bendX:ne,bendY:L,press:m.press,scaleX:h.x,scaleY:h.y,scaleZ:h.z,affineVolume:h.x*h.y*h.z})}function z(){if(i.info.autoReset=!1,i.info.reset(),!O&&!p.clay){A.updateMatrixWorld(!0),c.updateMatrixWorld(!0),E.uniforms.uDropToWorld.value.copy(k.matrixWorld),E.uniforms.uWorldToDrop.value.copy(k.matrixWorld).invert(),E.uniforms.uViewProjection.value.multiplyMatrices(c.projectionMatrix,c.matrixWorldInverse);let e=i.toneMapping;A.visible=!1,i.toneMapping=0,i.setRenderTarget(T),i.render(o,c),i.setRenderTarget(null),i.toneMapping=e,A.visible=!0}i.render(o,c)}function Ae(n){if(ae||oe||document.hidden)return;let r=ce?n-ce:0,a=Math.min(r/1e3,1/12);if(ce=n,p.paused||(l.tick(a),ke(a)),z(),r>0&&!p.paused){ue.push(r),ue.length>240&&ue.shift(),de||(de=n);let t=n-de;if(t>=3e4&&t<15e4&&fe.push(r),t>=15e4&&!pe){let t=[...fe].sort((e,t)=>e-t);e.dataset.benchmark=JSON.stringify({warmupSeconds:30,measurementSeconds:120,samples:t.length,medianMs:t[Math.floor(t.length*.5)],p95Ms:t[Math.floor(t.length*.95)],over50ms:t.filter(e=>e>50).length,quality:p.quality,lighting:p.lighting,inspection:p.inspection,dpr:i.getPixelRatio(),drawingBuffer:{width:e.width,height:e.height},userAgent:navigator.userAgent,source:`requestAnimationFrame intervals; not GPU time or input latency`}),pe=!0}}if(n-le>500&&ue.length){var o;le=n;let r=[...ue].sort((e,t)=>e-t),a=r[Math.floor(r.length/2)],s=r[Math.floor(r.length*.95)];(o=t.onStats)==null||o.call(t,{fps:Math.round(1e3/a),frameP95:Math.round(s*10)/10,grabbed:l.snapshot.grabbed}),e.dataset.renderStats=JSON.stringify({medianMs:a,p95Ms:s,calls:i.info.render.calls,triangles:i.info.render.triangles,textures:i.info.memory.textures,geometries:i.info.memory.geometries,width:e.width,height:e.height,quality:p.quality})}se=requestAnimationFrame(Ae)}e.style.touchAction=`none`,e.style.cursor=`grab`,e.addEventListener(`pointerdown`,Se),e.addEventListener(`pointermove`,Ce),e.addEventListener(`pointerup`,we),e.addEventListener(`pointercancel`,we),e.addEventListener(`lostpointercapture`,we),e.addEventListener(`touchstart`,Te,{passive:!1}),e.addEventListener(`touchmove`,Te,{passive:!1}),e.addEventListener(`webglcontextlost`,De),e.addEventListener(`webglcontextrestored`,Oe),window.addEventListener(`blur`,xe),document.addEventListener(`visibilitychange`,Ee);let je=new ResizeObserver(ve);return je.observe(e),ve(),ke(0),z(),se=requestAnimationFrame(Ae),(n=t.onReady)==null||n.call(t),{setOptions(e){if(ae)return;let t=e.lighting!==void 0&&e.lighting!==p.lighting,n=e.quality!==void 0&&e.quality!==p.quality,r=e.refinement!==void 0&&e.refinement!==p.refinement,a=e.clay!==void 0&&e.clay!==p.clay;if(Object.assign(p,e),l.setHue(p.hue),w.attenuationColor.set(du[p.hue]),E.uniforms.uTint.value.set(du[p.hue]),E.uniforms.uDaylight.value=+(p.lighting===`daylight`),P.material.uniforms.color.value.set(du[p.hue]),k.material=p.clay?D:O?w:E,P.visible=!p.clay,h.map=m[+!!p.inspection],h.bumpMap=p.inspection?null:m[0],h.needsUpdate=!0,t){let e=s;s=gu(i,p.lighting===`daylight`),o.environment=s.texture,e.dispose(),h.color.set(p.lighting===`daylight`?`#c6c9c2`:`#455157`),_.intensity=p.lighting===`daylight`?1.35:1,i.toneMappingExposure=p.lighting===`daylight`?1.13:mu.exposure}n&&ve(),p.paused&&xe(),r?(f.reset(),ke(0)):a&&ke(0),p.reducedMotion&&(u.reset(),d.reset(),f.reset(),ke(0)),ce=0,ye()},reset(){xe(),l.reset(),u.reset(),d.reset(),f.reset(),ke(0),ye(),ce=0},dispose(){ae||(xe(),ae=!0,cancelAnimationFrame(se),je.disconnect(),e.removeEventListener(`pointerdown`,Se),e.removeEventListener(`pointermove`,Ce),e.removeEventListener(`pointerup`,we),e.removeEventListener(`pointercancel`,we),e.removeEventListener(`lostpointercapture`,we),e.removeEventListener(`touchstart`,Te),e.removeEventListener(`touchmove`,Te),e.removeEventListener(`webglcontextlost`,De),e.removeEventListener(`webglcontextrestored`,Oe),window.removeEventListener(`blur`,xe),document.removeEventListener(`visibilitychange`,Ee),o.traverse(e=>{(e instanceof yi||e instanceof Fi)&&(e.geometry.dispose(),(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose()))}),m.forEach(e=>e.dispose()),s.dispose(),T.dispose(),O?E.dispose():w.dispose(),D.dispose(),p.clay&&(E.dispose(),w.dispose()),i.dispose())}}}var $=u();function bu(e,t){let n=new URL(window.location.href);t===null?n.searchParams.delete(e):n.searchParams.set(e,t),window.history.replaceState(window.history.state,``,n)}var xu=[{id:`cyan`,label:`CYAN`,name:`シアン`},{id:`rose`,label:`ROSE`,name:`ローズ`},{id:`amber`,label:`AMBER`,name:`アンバー`}];function Su(){var e;let t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),a=(0,_.useRef)(null),s=(0,_.useRef)(null),[l,u]=(0,_.useState)(`cyan`),[d,v]=(0,_.useState)(`studio`),[y,b]=(0,_.useState)(!1),[x,S]=(0,_.useState)(()=>new URLSearchParams(window.location.search).get(`feel`)===`baseline`?`baseline`:`refined`),[C,w]=(0,_.useState)(()=>new URLSearchParams(window.location.search).get(`view`)===`clay`),[T,E]=(0,_.useState)(()=>window.matchMedia(`(prefers-reduced-motion: reduce)`).matches),[D,O]=(0,_.useState)(`high`),[k,A]=(0,_.useState)(!1),[j,M]=(0,_.useState)(!1),[N,P]=(0,_.useState)(!1),[F,I]=(0,_.useState)(`loading`),[ee,te]=(0,_.useState)(``),[ne,L]=(0,_.useState)(!1),[re,ie]=(0,_.useState)(0),[R,ae]=(0,_.useState)({fps:0,frameP95:0,grabbed:!1});return(0,_.useEffect)(()=>{let e=t.current;if(!e)return;let r=!0;I(`loading`),te(``);try{n.current=yu(e,{onReady:()=>{r&&I(`ready`)},onError:e=>{r&&(te(e),I(`error`))},onStats:e=>{r&&ae(e)},onInteraction:()=>{r&&L(!0)}})}catch(e){te(e instanceof Error?e.message:`描画を開始できませんでした。`),I(`error`)}return()=>{var e;r=!1,(e=n.current)==null||e.dispose(),n.current=null}},[re]),(0,_.useEffect)(()=>{var e;(e=n.current)==null||e.setOptions({hue:l,lighting:d,inspection:y,refinement:x,clay:C,reducedMotion:T,quality:D,paused:k})},[l,d,y,x,C,T,D,k,re]),(0,_.useEffect)(()=>{let e=e=>{if(e.altKey||e.ctrlKey||e.metaKey||e.repeat)return;if(e.key===`Escape`){if(e.preventDefault(),j){var t;M(!1),(t=a.current)==null||t.focus()}else F===`ready`&&A(e=>!e);return}let r=e.target;if(!(r instanceof HTMLElement&&(r.isContentEditable||/^(INPUT|TEXTAREA|SELECT)$/.test(r.tagName)))&&e.key.toLowerCase()===`r`&&F===`ready`){var i;e.preventDefault(),(i=n.current)==null||i.reset(),A(!1)}};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[j,F]),(0,_.useEffect)(()=>{var e;if(!j)return;(e=s.current)==null||e.focus();let t=e=>{var t;e.target instanceof Node&&!((t=r.current)!=null&&t.contains(e.target))&&M(!1)};return window.addEventListener(`pointerdown`,t),()=>window.removeEventListener(`pointerdown`,t)},[j]),(0,$.jsx)(`div`,{className:`droplet-lab`,"data-hue":l,"data-lighting":d,children:(0,$.jsxs)(`div`,{className:`dl-shell`,children:[(0,$.jsxs)(`header`,{className:`dl-header`,children:[(0,$.jsxs)(`a`,{className:`dl-brand`,href:`./`,"aria-label":`PURA オリジナルへ`,children:[(0,$.jsx)(`span`,{className:`dl-brand-symbol`,"aria-hidden":`true`}),(0,$.jsxs)(`span`,{children:[`PURA`,(0,$.jsx)(`span`,{className:`dl-brand-period`,children:`.`})]})]}),(0,$.jsxs)(`div`,{className:`dl-edition`,children:[(0,$.jsx)(`span`,{children:`FLOW`}),(0,$.jsx)(`span`,{className:`dl-edition-rule`}),(0,$.jsxs)(`span`,{children:[`MATERIAL STUDY `,(0,$.jsx)(`b`,{children:`001`})]})]})]}),(0,$.jsxs)(`main`,{children:[(0,$.jsxs)(`div`,{className:`dl-intro`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`p`,{className:`dl-eyebrow`,children:[(0,$.jsx)(`span`,{}),`THE FEEL OF WATER`]}),(0,$.jsx)(`h1`,{children:`ひとしずくに、触れる。`}),(0,$.jsx)(`p`,{className:`dl-description`,children:`つかんで、滑らせて。光と、かたちを感じる。`})]}),(0,$.jsxs)(`div`,{className:`dl-study-note`,children:[(0,$.jsxs)(`span`,{className:`dl-study-number`,children:[`01 `,(0,$.jsx)(`span`,{children:`/ 01`})]}),(0,$.jsx)(`span`,{children:`一滴から、はじめる。`})]})]}),(0,$.jsxs)(`section`,{className:`dl-stage`,"aria-label":`水滴のプレイエリア`,"aria-busy":F===`loading`,children:[(0,$.jsx)(`canvas`,{ref:t,className:`dl-canvas${R.grabbed?` is-grabbed`:``}`,tabIndex:F===`ready`?0:-1,"aria-label":`水滴をつかんで動かせるプレイエリア`,"aria-describedby":`dl-play-instructions`}),(0,$.jsxs)(`div`,{className:`dl-stage-top`,"aria-hidden":`true`,children:[(0,$.jsxs)(`span`,{className:`dl-stage-label`,children:[(0,$.jsx)(`span`,{className:F===`ready`&&!k?`is-live`:``}),k?`PAUSED`:`ONE DROP, IN MOTION`]}),(0,$.jsx)(`span`,{className:`dl-stage-index`,children:`P / 001`})]}),(0,$.jsx)(`span`,{className:`dl-corner dl-corner-bl`,"aria-hidden":`true`}),(0,$.jsx)(`span`,{className:`dl-corner dl-corner-br`,"aria-hidden":`true`}),F===`loading`&&(0,$.jsxs)(`div`,{className:`dl-stage-overlay`,role:`status`,children:[(0,$.jsx)(`span`,{className:`dl-loading-orbit`,"aria-hidden":`true`}),(0,$.jsx)(`span`,{children:`光を整えています`})]}),F===`error`&&(0,$.jsxs)(`div`,{className:`dl-stage-overlay dl-error`,role:`alert`,children:[(0,$.jsx)(`p`,{children:`水滴を表示できませんでした`}),(0,$.jsx)(`span`,{children:`「もう一度試す」で、水滴の表示をやり直せます。`}),(0,$.jsxs)(`button`,{className:`dl-action-button`,onClick:()=>{A(!1),ie(e=>e+1)},children:[(0,$.jsx)(o,{size:15}),`もう一度試す`]}),(0,$.jsxs)(`details`,{children:[(0,$.jsx)(`summary`,{children:`詳細`}),(0,$.jsx)(`p`,{children:ee})]})]}),F===`ready`&&k&&(0,$.jsxs)(`div`,{className:`dl-stage-overlay dl-pause-overlay`,children:[(0,$.jsxs)(`button`,{className:`dl-resume`,onClick:()=>A(!1),children:[(0,$.jsx)(c,{size:18,fill:`currentColor`}),(0,$.jsx)(`span`,{children:`つづける`})]}),(0,$.jsx)(`span`,{children:`ひと休み。`})]}),F===`ready`&&!k&&(0,$.jsxs)(`div`,{className:`dl-touch-hint${ne?` is-dismissed`:``}`,"aria-hidden":`true`,children:[(0,$.jsx)(`span`,{className:`dl-hint-dot`}),`水滴をつかんで、ゆっくり動かす`]}),(0,$.jsxs)(`div`,{className:`dl-stage-bottom`,"aria-hidden":`true`,children:[(0,$.jsx)(`span`,{children:d===`studio`?`SOFT STUDIO LIGHT`:`NATURAL DAYLIGHT`}),(0,$.jsxs)(`span`,{children:[(e=xu.find(e=>e.id===l))==null?void 0:e.label,` / 100%`]})]})]}),(0,$.jsxs)(`div`,{className:`dl-controls`,"aria-label":`水滴の見た目と操作`,children:[(0,$.jsxs)(`div`,{className:`dl-control-group dl-colors`,children:[(0,$.jsx)(`span`,{className:`dl-control-label`,children:`色`}),(0,$.jsx)(`div`,{className:`dl-color-options`,role:`group`,"aria-label":`水滴の色`,children:xu.map(e=>(0,$.jsxs)(`button`,{className:`dl-color${l===e.id?` is-active`:``}`,"data-color":e.id,onClick:()=>u(e.id),"aria-label":e.name,"aria-pressed":l===e.id,children:[(0,$.jsx)(`span`,{className:`dl-swatch`,children:l===e.id&&(0,$.jsx)(p,{size:12,strokeWidth:2.8})}),(0,$.jsx)(`span`,{children:e.label})]},e.id))})]}),(0,$.jsxs)(`div`,{className:`dl-control-group dl-lighting`,children:[(0,$.jsx)(`span`,{className:`dl-control-label`,children:`光`}),(0,$.jsxs)(`div`,{className:`dl-segment`,role:`group`,"aria-label":`照明`,children:[(0,$.jsx)(`button`,{className:d===`studio`?`is-active`:``,onClick:()=>v(`studio`),"aria-pressed":d===`studio`,children:`スタジオ`}),(0,$.jsx)(`button`,{className:d===`daylight`?`is-active`:``,onClick:()=>v(`daylight`),"aria-pressed":d===`daylight`,children:`自然光`})]})]}),(0,$.jsxs)(`div`,{className:`dl-control-actions`,children:[(0,$.jsxs)(`button`,{className:`dl-quiet-button dl-floor-toggle${y?` is-active`:``}`,"aria-pressed":y,onClick:()=>b(e=>!e),title:`床の模様を切り替える`,children:[(0,$.jsx)(m,{size:15}),(0,$.jsx)(`span`,{children:`屈折を見る`})]}),(0,$.jsx)(`span`,{className:`dl-control-divider`,"aria-hidden":`true`}),(0,$.jsxs)(`button`,{className:`dl-quiet-button dl-reset`,onClick:()=>{var e;(e=n.current)==null||e.reset(),A(!1)},disabled:F!==`ready`,title:`水滴を元の位置に戻す（R）`,children:[(0,$.jsx)(o,{size:15}),(0,$.jsx)(`span`,{children:`リセット`})]}),(0,$.jsxs)(`div`,{className:`dl-settings`,ref:r,children:[(0,$.jsx)(`button`,{className:`dl-icon-button${j?` is-active`:``}`,ref:a,"aria-label":`表示と動きの設定`,"aria-expanded":j,"aria-controls":`dl-settings-panel`,onClick:()=>M(e=>!e),children:(0,$.jsx)(h,{size:17})}),j&&(0,$.jsxs)(`div`,{className:`dl-settings-panel`,id:`dl-settings-panel`,role:`dialog`,"aria-label":`表示と動きの設定`,children:[(0,$.jsxs)(`div`,{className:`dl-settings-heading`,children:[(0,$.jsx)(`span`,{children:`表示と動き`}),(0,$.jsx)(`button`,{className:`dl-icon-button`,ref:s,"aria-label":`設定を閉じる`,onClick:()=>{var e;M(!1),(e=a.current)==null||e.focus()},children:(0,$.jsx)(g,{size:15})})]}),(0,$.jsxs)(`div`,{className:`dl-comparison-settings`,children:[(0,$.jsxs)(`label`,{className:`dl-setting-row dl-select-setting`,children:[(0,$.jsx)(`span`,{children:`触り心地`}),(0,$.jsxs)(`select`,{value:x,onChange:e=>{let t=e.target.value;S(t),bu(`feel`,t)},"aria-describedby":`dl-feel-description`,children:[(0,$.jsx)(`option`,{value:`refined`,children:`今回の調整`}),(0,$.jsx)(`option`,{value:`baseline`,children:`保存した感触`})]})]}),(0,$.jsx)(`p`,{className:`dl-setting-description`,id:`dl-feel-description`,children:`いつでも保存した感触に戻せます。`}),(0,$.jsxs)(`label`,{className:`dl-setting-row`,children:[(0,$.jsx)(`span`,{children:`形だけを見る`}),(0,$.jsx)(`input`,{type:`checkbox`,checked:C,onChange:e=>{w(e.target.checked),bu(`view`,e.target.checked?`clay`:null)},"aria-describedby":`dl-shape-description`}),(0,$.jsx)(`span`,{className:`dl-switch`,"aria-hidden":`true`})]}),(0,$.jsx)(`p`,{className:`dl-setting-description`,id:`dl-shape-description`,children:`透明感を隠して、輪郭と揺れを確かめる。`})]}),(0,$.jsxs)(`label`,{className:`dl-setting-row`,children:[(0,$.jsx)(`span`,{children:`揺れを控えめに`}),(0,$.jsx)(`input`,{type:`checkbox`,checked:T,onChange:e=>E(e.target.checked)}),(0,$.jsx)(`span`,{className:`dl-switch`,"aria-hidden":`true`})]}),(0,$.jsxs)(`label`,{className:`dl-setting-row dl-select-setting`,children:[(0,$.jsx)(`span`,{children:`画質`}),(0,$.jsxs)(`select`,{value:D,onChange:e=>O(e.target.value),children:[(0,$.jsx)(`option`,{value:`high`,children:`美しさを優先`}),(0,$.jsx)(`option`,{value:`balanced`,children:`軽さを優先`})]})]}),(0,$.jsxs)(`label`,{className:`dl-setting-row`,children:[(0,$.jsx)(`span`,{children:`動作情報を表示`}),(0,$.jsx)(`input`,{type:`checkbox`,checked:N,onChange:e=>P(e.target.checked)}),(0,$.jsx)(`span`,{className:`dl-switch`,"aria-hidden":`true`})]}),(0,$.jsxs)(`button`,{className:`dl-pause-setting`,disabled:F!==`ready`,onClick:()=>{var e;A(e=>!e),M(!1),(e=a.current)==null||e.focus()},children:[k?(0,$.jsx)(c,{size:14}):(0,$.jsx)(i,{size:14}),(0,$.jsx)(`span`,{children:k?`再開する`:`一時停止`}),(0,$.jsx)(`kbd`,{children:`Esc`})]})]})]})]})]}),(0,$.jsxs)(`p`,{className:`dl-play-instructions`,id:`dl-play-instructions`,children:[`つかんで移動 · 離すと滑る`,(0,$.jsx)(`span`,{children:`R でリセット · Esc で一時停止`})]})]}),(0,$.jsxs)(`footer`,{className:`dl-footer`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{className:`dl-footer-title`,children:`A LITTLE MOMENT OF FLOW.`}),(0,$.jsx)(`p`,{children:`一滴の質感と動きの試作。融合は、次のステップで。`})]}),(0,$.jsxs)(`div`,{className:`dl-footer-right`,children:[N&&(0,$.jsxs)(`output`,{className:`dl-stats`,"aria-label":`描画の動作情報`,children:[Math.round(R.fps),` fps`,(0,$.jsxs)(`span`,{children:[`p95 `,R.frameP95.toFixed(1),` ms`]})]}),(0,$.jsxs)(`a`,{href:`./`,children:[`PURA オリジナル`,(0,$.jsx)(f,{size:14})]})]})]})]})})}export{Su as DropletLab,Su as default};